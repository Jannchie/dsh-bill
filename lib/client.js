 ...
 *      the pills' own geometry, opening the report on click.
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = `
      ...
      .dshbill-field:focus-visible,.dshbill-pill:focus-visible,
    ...
    var DICT_EN = {
      ...
      'turn.tipOut': ' · output ',
      'dock.tip': "This session's cost · click to open the report",
    ...
    // session's cost, and nothing else — the all-time total and the peak split
    // belong to the report one click away, not to a row of glanceable numbers.
    //
    ...
    function CoinsIcon() {
      return el('svg', {
        width: 16, height: 16, viewBox: '0 0 16 16', fill: 'none', 'aria-hidden': 'true', strokeWidth: 1,
      },
